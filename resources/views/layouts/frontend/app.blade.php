...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="index.html" class="logo mr-auto"><img src="{{asset('public/assets/img/logo.png')}}" alt=""></a>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <ul>
            <li><a href="{{route('customer_login')}}">Customer</a></li>
            <li><a href="{{route('doctor_login')}}">Doctor</a></li>
          </ul>
        </li>
